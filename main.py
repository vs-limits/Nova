...
def settings_from_args(args: argparse.Namespace) -> RuntimeSettings:
    ...
    return RuntimeSettings(
        ...
        command_injection_probes=settings.command_injection_probes,
        fetch_same_origin_scripts=settings.fetch_same_origin_scripts,
        max_script_bytes=settings.max_script_bytes,
        ssrf_callback_url=settings.ssrf_callback_url,
        stored_xss_probes=settings.stored_xss_probes,
        file_upload_probes=settings.file_upload_probes,
        open_redirect_probes=settings.open_redirect_probes,
        ...
        llm_payload_max_total=settings.llm_payload_max_total,
